...
export default function AgentChats({ chat }: AgentChatsProps) {
    const { profile } = useAccount()

    return chat.role === "user" ? <div className='w-full  flex justify-end '>
    ...
    </div> : <div className='w-full justify-start'>
        <div className='  flex gap-2 p-1'>
            ...
            <div className='flex p-4 rounded-3xl bg-gray-200 flex-col'>
                <TypedMarkdown text={chat.content} />
            </div>
        </div>
    </div>
