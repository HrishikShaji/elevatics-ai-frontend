    ...
    return (
        <div>
            ...
            >
                <button
                    type="button"
                    className="absolute bottom-0 hidden top-0 my-auto flex h-10 w-12 cursor-pointer items-center justify-center bg-primary text-white ltr:-left-12 ltr:rounded-bl-full ltr:rounded-tl-full rtl:-right-12 rtl:rounded-br-full rtl:rounded-tr-full"
